	...
	const getContent = () => {
		if (reason === 'payment_required') {
			return {
				...
				description:
					'Please update your payment method to resume your organization and continue using all features.',
				primaryAction: {
				...
				secondaryAction: {
					...
					onClick: () => window.open('mailto:hello@sharkly.co', '_blank'),
		...
		<div className="flex h-full flex-col items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
			<div className="w-full max-w-md space-y-8">
				<div className="text-center">
					<div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-lg dark:bg-gray-800">
						{content.icon}
					</div>
					...
					<p className="mt-4 text-sm text-gray-600 dark:text-gray-400">{content.description}</p>
				</div>
					...
					<div className="flex">
						...
						<div className="ml-3">
							...
							<div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
								<p>
									If you're having trouble with your organization or need assistance, please contact
									our support team.
								</p>
							</div>
						</div>
