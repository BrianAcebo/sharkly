	...
	const testPushNotification = async () => {
		...
		if (currentPermission === 'granted') {
			try {
				...
				const notification = new Notification('Sharkly', {
							...
							<form onSubmit={handleProfileSubmit} className="space-y-4">
								...
								<div className="flex flex-col items-center space-y-4">
									<div className="relative">
										{avatarPreview ? (
											<div className="relative rounded-full border-2 border-gray-300 dark:border-gray-700">
												<img
													src={avatarPreview}
													alt="Avatar preview"
												...
												<label className="relative inline-flex cursor-pointer items-center">
													<input
														...
														checked={
															...
															notifications.caseStatusChange &&
															notifications.caseFollowUp
														}
														onChange={(e) => {
												...
												<label className="relative inline-flex cursor-pointer items-center">
													<input
														...
														checked={
															...
															notifications.followUpSuggestions
														}
														onChange={(e) => {
															const checked = e.target.checked;
															setNotifications((prev) => ({
					...
					<div className="w-full max-w-md rounded-lg bg-white p-6 dark:bg-gray-900">
						...
						<div className="mb-6">
							...
							<p className="text-sm text-gray-600 dark:text-gray-300">
								All your data, including cases, tasks, and account information will be permanently
								deleted. You will lose access to all organizations and data associated with this
								account.
							</p>
						</div>
