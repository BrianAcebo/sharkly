...
export interface TooltipProps {
	...
	/** Merged last via `cn` / tailwind-merge — override width/max-width if needed. */
	className?: string;
...
export function Tooltip({
	...
	const tooltipContent = (
		<span
			className={cn(
				'pointer-events-none z-[9999] w-max max-w-[340px] min-w-0 whitespace-normal rounded bg-black px-3 py-2 text-left text-xs text-white',
