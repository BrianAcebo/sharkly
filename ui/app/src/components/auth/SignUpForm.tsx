		...
		<div className="no-scrollbar flex w-full flex-1 flex-col overflow-y-auto lg:w-1/2">
			...
			<div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
				<div>
					...
					<div>
						{message && (
							<p className="dark:text-success-400 text-success-500 mb-4 text-center text-sm">
								{message}
							</p>
						)}
						{isRateLimited && (
							<p className="text-error-500 mb-4 text-center text-sm">
								...
								<div className="flex items-center gap-3">
									...
									<p className="inline-block text-sm font-normal text-gray-500 dark:text-gray-400">
										...
										<a
											...
											className="text-gray-900 underline dark:text-white/90"
