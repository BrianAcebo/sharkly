...
* 15–20 supporting informational articles as child pages
...
### **Step 3: Select Low-Competition High-Potential Keywords**

Keyword Golden Ratio test: search 'allintitle:\[keyword\]'. Divide result count by monthly search volume. KGR \< 0.25 \= underserved opportunity.

KGR \= allintitle\_results / monthly\_search\_volume  →  Target KGR \< 0.25
...
Schedule: 1 money page \+ 15–20 supporting articles per target topic per month. Include: primary keyword, URL, title tag, word count target, publish date, assigned writer, and internal linking targets. The calendar is an execution plan, not a publishing schedule.
