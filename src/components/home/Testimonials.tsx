			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-16 text-center">
					...
					<p className="mx-auto max-w-3xl text-xl text-gray-600 dark:text-gray-300">
						Hundreds of business owners rely on Sharkly to build their SEO strategy, generate
						optimized content, and track their rankings without becoming an SEO expert.
					</p>
				</div>
				...
				<div className="border-t border-gray-200 pt-16 dark:border-gray-700">
					<div className="mb-12 text-center">
						...
						<p className="text-gray-600 dark:text-gray-300">
							Built with security‑first principles and compliant evidence controls
						</p>
					</div>
