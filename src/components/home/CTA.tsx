				...
				<div className="text-center">
                    ...
                    <div className="mb-12">
                        ...
                        <p className="text-blue-light-100 mx-auto mb-8 max-w-3xl text-xl md:text-2xl">
                            Join investigators who replaced scattered tools with an AI assistant that gathers facts, links data, and drafts reports on‑demand.
                        </p>
                    </div>
                    ...
                    <div className="mx-auto mb-12 grid max-w-4xl grid-cols-1 gap-8 md:grid-cols-3">
						<div className="flex flex-col items-center">
                            ...
                            <h3 className="mb-2 text-lg font-semibold text-white">Always‑On Assistant</h3>
                            <p className="text-blue-light-100 text-center">AI that researches, links, and drafts while you’re on the case</p>
						</div>
						...
						<div className="flex flex-col items-center">
                            ...
                            <h3 className="mb-2 text-lg font-semibold text-white">Case‑Ready Security</h3>
                            <p className="text-blue-light-100 text-center">Chain‑of‑custody friendly storage and exports</p>
						</div>
						...
						<div className="flex flex-col items-center">
                            ...
                            <h3 className="mb-2 text-lg font-semibold text-white">Case OS Included</h3>
                            <p className="text-blue-light-100 text-center">Notes, tasks, and drafts integrated into your workflow</p>
						</div>
					</div>
					...
					<div className="mt-12 border-t border-white/20 pt-8">
						...
						<div className="flex items-center justify-center space-x-8 text-white/60">
							<span className="text-sm font-medium">10,000+ Cases Qualified</span>
