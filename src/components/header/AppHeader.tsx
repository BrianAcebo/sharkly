...
const Header: React.FC = () => {
	...
	return (
		<>
			<header
				ref={headerRef}
				className="sticky top-0 border-b border-gray-200 bg-white px-6 py-4 dark:border-gray-600 dark:bg-gray-900"
			>
					...
					<div ref={searchRef} className="relative w-full max-w-[400px] 2xl:max-w-[600px]">
						...
						>
							...
							<div className="ml-auto flex items-center space-x-1">
								<kbd className="rounded bg-gray-200 px-1.5 py-0.5 text-xs dark:bg-gray-700">⌘</kbd>
