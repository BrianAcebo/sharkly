...
const Input = forwardRef<HTMLInputElement, InputProps>(
	(
		...
		if (disabled) {
			inputClasses += ` text-gray-500 border-gray-300 opacity-40 bg-gray-100 cursor-not-allowed dark:bg-gray-900 dark:text-gray-400 dark:border-gray-700 opacity-40`;
		} else if (error) {
