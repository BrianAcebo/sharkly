  ...
  try {
    ...
    if (!eligibilityData.eligible) {
      if (eligibilityData.requires_manual_review) {
        return res.status(400).json({
          ...
          message: 'Your refund request requires manual review. Please email support@truesight.com with your request.',
    ...
    try {
      ...
      return res.status(500).json({
        ...
        message: stripeError.message || 'Please contact support@truesight.com'
      });
    }
  } catch (error) {
  ...
  try {
    ...
    if (!chargeId) {
      ...
      try {
        ...
        if (org?.stripe_customer_id) {
          ...
          const walletCharge = stripeCharges.data.find(c => 
            c.status === 'succeeded' && 
    ...
    if (!chargeId) {
      return res.status(400).json({
        ...
        message: 'Please email support@truesight.com with your refund request. We\'ll process it manually within 1-2 business days.'
      });
    }
    ...
    try {
      ...
      return res.json({
        ...
        refund_amount_cents: eligibilityData.refund_amount_cents,
        refund_amount_dollars: (eligibilityData.refund_amount_cents / 100).toFixed(2),
        message: 'Wallet refund processed successfully. It may take 5-10 business days to appear on your statement.'
      });
    } catch (stripeError: any) {
  ...
  try {
    ...
    if (credits > 50) {
      return res.status(400).json({ 
        ...
        message: 'For large credit refunds, please email support@truesight.com'
      });
    }
